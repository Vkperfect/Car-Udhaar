...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      ...
      <p>Choosing the right car rental can be like finding the perfect travel buddy &#8209; &nbsp; it needs to complement your style, handle your needs, and maybe even surprise you with hidden talents. That's why we're not just a rental service, we're your car rental matchmaker!</p>
    </div>
    <div class="row"> 
    ...
    <div class="row">
      <div class="col-lg-3 col-xs-6 col-sm-3">
        <div class="fun-facts-m">
          <div class="cell">
            <h2><i class="fa fa-calendar" aria-hidden="true"></i>200+</h2>
            <p> Hours In Business</p>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-xs-6 col-sm-3">
